...
#
# You can follow the conplete instructions at 
...
# Add /usr/local/git
# Add all /usr bin stuff
# Add ~/bin for local links and tools
# Add RVM to PATH for scripting
PATH=/usr/local/git/bin:/usr/local/sbin:/usr/local/bin:$HOME/bin:$HOME/.rvm/bin:$PATH 
